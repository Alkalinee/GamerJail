...
using Standard;
using MONITORINFO = MahApps.Metro.Native.MONITORINFO;
    ...
    public class BorderlessWindowBehavior : Behavior<Window>
    {
        ...
        protected override void OnAttached()
        {
            ...
            if (metroWindow != null)
            {
                ...
                DependencyPropertyDescriptor.FromProperty(MetroWindow.IgnoreTaskbarOnMaximizeProperty, typeof(MetroWindow))
                      .AddValueChanged(AssociatedObject, IgnoreTaskbarOnMaximizePropertyChangedCallback);
                DependencyPropertyDescriptor.FromProperty(MetroWindow.UseNoneWindowStyleProperty, typeof(MetroWindow))
